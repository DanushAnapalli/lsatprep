...
export default function LawThemeLSATLanding() {
  ...
  // Show loading while checking auth or if user is logged in (redirecting to dashboard)
  if (authLoading || user) {
    return (
        ...
        <main className="relative mx-auto w-full max-w-7xl px-6 pb-24 pt-16">
          <div className="grid min-h-[70vh] items-center gap-16 lg:grid-cols-2">
            <div>
              ...
              >
                <PrimaryButton onClick={handleGetStarted}>Get Started Free</PrimaryButton>
          ...
          <section id="features" className="mt-24">
            ...
            <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
              ...
              <div className="flex gap-3">
                ...
                <PrimaryButton onClick={handleGetStarted}>Start Practicing</PrimaryButton>
              </div>
            </div>
          ...
          <section id="pricing" className="mt-24">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              ...
              >
                ...
                <div className="mt-6">
                  <SecondaryButton onClick={handleGetStarted}>Get Started</SecondaryButton>
                </div>
              </div>
              ...
              >
                ...
                <div className="mt-2 font-serif text-4xl font-bold text-stone-900 dark:text-stone-100">$14</div>
                ...
                <div className="mt-6">
                  <PrimaryButton onClick={handleGetStarted}>Get Pro</PrimaryButton>
                </div>
              </div>
